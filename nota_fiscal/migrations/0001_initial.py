    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cst_icms_aplicado', models.CharField(blank=True, max_length=5, null=True, verbose_name='CST/CSOSN ICMS Aplicado')),
                ...
                ('cst_ipi_aplicado', models.CharField(blank=True, max_length=2, null=True, verbose_name='CST IPI Aplicado')),
                ...
                ('cst_pis_aplicado', models.CharField(blank=True, max_length=2, null=True, verbose_name='CST PIS Aplicado')),
                ...
                ('cst_cofins_aplicado', models.CharField(blank=True, max_length=2, null=True, verbose_name='CST COFINS Aplicado')),
