...
from .ncm_utils import formatar_codigo_ncm, normalizar_codigo_ncm
...
class NCM(models.Model):
    ...
    def codigo_formatado(self):
        return formatar_codigo_ncm(self.codigo)

    def save(self, *args, **kwargs):
        self.codigo = normalizar_codigo_ncm(self.codigo)
...
# ðŸ›’ Produto principal â€” agora usado também como item da nota
class Produto(models.Model):
    ...
    # ðŸ§¾ Nota fiscal de origem (para importação XML)
